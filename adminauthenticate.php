...
{
			echo "<center><h1><b>มีข้อผิดพลาดเกิดขึ้น โปรดลงชื่อเข้าใช้อีกครั้ง<b> </h1></center><br><br>";
echo '<center><table><tr><td><A href="adminindex.php"><button style="background-color:black; border-color:black"><span style="color:white">ลงชื่อเข้าใช้ ! &nbsp&nbspอีกครั้ง</span></button></a></td></tr></table></center>';
}
