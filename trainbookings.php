...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
    ...
    <title>YANIDA-TICKET DATABASE</title>
    <style>
        body {
...
<body>
<div class="container">
        <h2><img src="https://img.icons8.com/nolan/64/database.png" alt="Database Icon" /> ข้อมูลการจองรถไฟ <img src="https://img.icons8.com/ultraviolet/60/000000/train.png" alt="Train Icon" /></h2>
            ...
            <tbody>
                ...
                while ($row = $result->fetch_assoc()) {
                    echo '<tr>
                        ...
                        <td><a href="print.php?pid=' . $row["T_No."] . '" target="_blank" class="btn btn-primary btn-sm"><i class="fas fa-print"></i> พิมพ์</a></td>
                        <td>
                            <form method="POST" action="delete_transaction.php">
                                <input type="hidden" name="transaction_id" value="' . $row["T_No."] . '">
